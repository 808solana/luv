...
export interface CoverflowSlide {
  ...
  /** How the cover image fills the square. Logos use contain. */
  fit?: "cover" | "contain";
    ...
    >
      <div className="relative">
        <div
          ...
          className="cursor-grab overflow-hidden py-10 outline-none ring-0 focus:outline-none focus-visible:outline-none focus-visible:ring-0 active:cursor-grabbing"
          style={{
